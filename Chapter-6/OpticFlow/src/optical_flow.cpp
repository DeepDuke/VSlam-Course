...
string file_1 = "../src/1.png";  // first image
string file_2 = "../src/2.png";  // second image
...
int main(int argc, char **argv) {
    ...
    // Save img
    cv::imwrite("../src/img2_single_forward.jpg", img2_single);
    cv::imwrite("../src/img2_multi_forward.jpg", img2_multi);
    cv::imwrite("../src/img2_CV.jpg", img2_CV);
...
void OpticalFlowMultiLevel(
    ...
    for (int i = pyramids - 1; i >= 0; i--) {
        ...
        vsuccess.clear();
        OpticalFlowSingleLevel(pyr1[i], pyr2[i], vkp1, vkp2_now, vsuccess, inverse);
        vkp2_last.clear();
