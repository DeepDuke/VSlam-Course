...
string image_file = "../src/test.png";   // 请确保路径正确
...
int main(int argc, char **argv) {
    ...
    for (int v = 0; v < rows; v++)
        for (int u = 0; u < cols; u++) {
            ...
            u_distorted = x_undistorted * fx + cx;
            v_distorted = y_undistorted * fy + cy;
            // end your code here
    ...
    // 画图去畸变后图像
    cv::imwrite("../src/image_undistorted.jpg", image_undistort);
